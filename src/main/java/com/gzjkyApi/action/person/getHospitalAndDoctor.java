...
public class getHospitalAndDoctor extends ApiBaseAction {
	...
	public String doExec() throws Exception {
		...
		patientAndDoctorHospitalList = patientAndHospitalDoctorReadMapper.selectByPatientId(Integer.parseInt("40"));
		...
		result = JSONArray.fromObject(patientAndDoctorHospitalList, jsonConfig);
